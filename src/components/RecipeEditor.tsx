...
export const SECTORS = ['Brigadeiro', 'Chocolate', 'Bolos', 'Artes e Decoração', 'Outros'];

export const SPECIALTIES = [
    'Bem-Casado',
    'Bem-Nascido',
    'Bem-Vivido',
    'Bico & Flores de Açúcar',
    'Biscoitos Amanteigados',
    'Bolo de Rolo',
    'Brigadeiros de Tacho',
    'Brownie & Suspiro',
    'Butter Cream',
    'Chocolates',
    'Cocada',
    ...
    'Naked Cake',
    'Palha Italiana',
    'Papel de Arroz & Flores de Açúcar',
    'Pasta Americana & Flores de Açúcar',
    'Pintura & Flores de Açúcar',
    'Rendado',
    'Rendado & Flores de Açúcar',
    'Semi Naked',
    'Sobremesas'
];

export const RecipeEditor: React.FC<RecipeEditorProps> = ({ onClose, initialData }) => {
    const { ingredients, recipes, addRecipe, updateRecipe, addIngredient, updateIngredient } = useStore();

    // State
    const [formData, setFormData] = useState({
        name: initialData?.name || '',
        productType: initialData?.productType || 'Final' as 'Base' | 'Final',
        sector: (initialData?.sector || 'Brigadeiro') as any,
